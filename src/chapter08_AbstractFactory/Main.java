...
public class Main {
    public static void main(String[] args) {
        if (args.length != 1) {
            ...
            System.out.println("Example 1: java Main chapter08_AbstractFactory.listfactory.ListFactory");
            System.out.println("Example 2: java Main chapter08_AbstractFactory.tablefactory.TableFactory");
            System.exit(0);
        }
